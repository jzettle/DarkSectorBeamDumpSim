...
#ifndef DarkSectorSimFastScintillation_h
#define DarkSectorSimFastScintillation_h 1
...
class DarkSectorSimFastScintillation : public G4VRestDiscreteProcess
{
...
public:
	...
	explicit DarkSectorSimFastScintillation(const G4String& processName = "Scintillation",
                                 G4ProcessType type = fElectromagnetic);
	~DarkSectorSimFastScintillation();

private:

        DarkSectorSimFastScintillation(const DarkSectorSimFastScintillation &right) = delete;

        //////////////
        // Operators
        //////////////

        DarkSectorSimFastScintillation& operator=(const DarkSectorSimFastScintillation &right) = delete;
...
public:
        ...
        G4double GetQuenchingFactor(G4String aParticleName, G4double aTotalEnergyDeposit);
        // Returns ER/NR quenching factor value

        G4double GetComponentRatio(G4String aParticleName, G4double aTotalEnergyDeposit);
        // Returns energy dependent yield ratio
...
inline
void DarkSectorSimFastScintillation::SetTrackSecondariesFirst(const G4bool state)
{
        fTrackSecondariesFirst = state;
}

inline
G4bool DarkSectorSimFastScintillation::GetTrackSecondariesFirst() const
{
        return fTrackSecondariesFirst;
}

inline
void DarkSectorSimFastScintillation::SetFiniteRiseTime(const G4bool state)
{
        fFiniteRiseTime = state;
}

inline 
G4bool DarkSectorSimFastScintillation::GetFiniteRiseTime() const
{
        return fFiniteRiseTime;
}

inline
void DarkSectorSimFastScintillation::SetScintillationYieldFactor(const G4double yieldfactor)
{
        fYieldFactor = yieldfactor;
}

inline
G4double DarkSectorSimFastScintillation::GetScintillationYieldFactor() const
{
        return fYieldFactor;
}

inline
void DarkSectorSimFastScintillation::SetScintillationExcitationRatio(const G4double ratio)
{
        fExcitationRatio = ratio;
}

inline
G4double DarkSectorSimFastScintillation::GetScintillationExcitationRatio() const
{
        return fExcitationRatio;
}

inline
G4PhysicsTable* DarkSectorSimFastScintillation::GetSlowIntegralTable() const
{
        return fSlowIntegralTable;
}

inline
G4PhysicsTable* DarkSectorSimFastScintillation::GetFastIntegralTable() const
{
        return fFastIntegralTable;
}

inline
void DarkSectorSimFastScintillation::AddSaturation(G4EmSaturation* sat)
{
        fEmSaturation = sat;
}

inline
void DarkSectorSimFastScintillation::RemoveSaturation()
{
        fEmSaturation = nullptr;
}

inline
G4EmSaturation* DarkSectorSimFastScintillation::GetSaturation() const
{
        return fEmSaturation;
}

inline
G4bool DarkSectorSimFastScintillation::GetScintillationByParticleType() const
{
        return fScintillationByParticleType;
}

inline
void DarkSectorSimFastScintillation::SetScintillationTrackInfo(const G4bool trackType)
{
        fScintillationTrackInfo = trackType;
}

inline
G4bool DarkSectorSimFastScintillation::GetScintillationTrackInfo() const
{
        return fScintillationTrackInfo;
}

inline
void DarkSectorSimFastScintillation::SetStackPhotons(const G4bool stackingFlag)
{
        fStackingFlag = stackingFlag;
}

inline
G4bool DarkSectorSimFastScintillation::GetStackPhotons() const
{
        return fStackingFlag;
}

inline
G4int DarkSectorSimFastScintillation::GetNumPhotons() const
{
        return fNumPhotons;
}
...
inline
G4double DarkSectorSimFastScintillation::single_exp(G4double t, G4double tau2)
{
         return std::exp(-1.0*t/tau2)/tau2;
}

inline
G4double DarkSectorSimFastScintillation::bi_exp(G4double t, G4double tau1, G4double tau2)
{
         return std::exp(-1.0*t/tau2)*(1-std::exp(-1.0*t/tau1))/tau2/tau2*(tau1+tau2);
}

#endif /* DarkSectorSimScintillation_h */
