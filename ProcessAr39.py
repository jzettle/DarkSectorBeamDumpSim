...
##################################################
N_JOBS             = 1000
OUTDIR             = "/pnfs/ldrd/darksectorldrd/persistent/users/{USER}/darksectorsim/Ar39_".format(USER = os.getenv("USER")) + str(random.randint(0,10000)) + "/"
...
def main():
  ...
  shutil.copy("ar39.sh", cache_folder)
