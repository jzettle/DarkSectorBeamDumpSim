...
#ifndef DarkSectorSimScintillation_h
#define DarkSectorSimScintillation_h 1
...
public:
	...
	explicit DarkSectorSimScintillation(const G4String& processName = "Scintillation",
                                 G4ProcessType type = fElectromagnetic);
	~DarkSectorSimScintillation();

private:

        DarkSectorSimScintillation(const DarkSectorSimScintillation &right) = delete;

        //////////////
        // Operators
        //////////////

        DarkSectorSimScintillation& operator=(const DarkSectorSimScintillation &right) = delete;
...
inline
void DarkSectorSimScintillation::SetTrackSecondariesFirst(const G4bool state)
{
        fTrackSecondariesFirst = state;
}

inline
G4bool DarkSectorSimScintillation::GetTrackSecondariesFirst() const
{
        return fTrackSecondariesFirst;
}

inline
void DarkSectorSimScintillation::SetFiniteRiseTime(const G4bool state)
{
        fFiniteRiseTime = state;
}

inline 
G4bool DarkSectorSimScintillation::GetFiniteRiseTime() const
{
        return fFiniteRiseTime;
}

inline
void DarkSectorSimScintillation::SetScintillationYieldFactor(const G4double yieldfactor)
{
        fYieldFactor = yieldfactor;
}

inline
G4double DarkSectorSimScintillation::GetScintillationYieldFactor() const
{
        return fYieldFactor;
}

inline
void DarkSectorSimScintillation::SetScintillationExcitationRatio(const G4double ratio)
{
        fExcitationRatio = ratio;
}

inline
G4double DarkSectorSimScintillation::GetScintillationExcitationRatio() const
{
        return fExcitationRatio;
}

inline
G4PhysicsTable* DarkSectorSimScintillation::GetSlowIntegralTable() const
{
        return fSlowIntegralTable;
}

inline
G4PhysicsTable* DarkSectorSimScintillation::GetFastIntegralTable() const
{
        return fFastIntegralTable;
}

inline
void DarkSectorSimScintillation::AddSaturation(G4EmSaturation* sat)
{
        fEmSaturation = sat;
}

inline
void DarkSectorSimScintillation::RemoveSaturation()
{
        fEmSaturation = nullptr;
}

inline
G4EmSaturation* DarkSectorSimScintillation::GetSaturation() const
{
        return fEmSaturation;
}

inline
G4bool DarkSectorSimScintillation::GetScintillationByParticleType() const
{
        return fScintillationByParticleType;
}

inline
void DarkSectorSimScintillation::SetScintillationTrackInfo(const G4bool trackType)
{
        fScintillationTrackInfo = trackType;
}

inline
G4bool DarkSectorSimScintillation::GetScintillationTrackInfo() const
{
        return fScintillationTrackInfo;
}

inline
void DarkSectorSimScintillation::SetStackPhotons(const G4bool stackingFlag)
{
        fStackingFlag = stackingFlag;
}

inline
G4bool DarkSectorSimScintillation::GetStackPhotons() const
{
        return fStackingFlag;
}

inline
G4int DarkSectorSimScintillation::GetNumPhotons() const
{
        return fNumPhotons;
}
...
inline
G4double DarkSectorSimScintillation::single_exp(G4double t, G4double tau2)
{
         return std::exp(-1.0*t/tau2)/tau2;
}

inline
G4double DarkSectorSimScintillation::bi_exp(G4double t, G4double tau1, G4double tau2)
{
